...
Latest release: [ScanID 1.1.2](https://github.com/GINNOV/poligest/releases/tag/scanid-v1.1.2)

Direct DMG: [ScanID-1.1.2.dmg](https://github.com/GINNOV/poligest/releases/download/scanid-v1.1.2/ScanID-1.1.2.dmg)
...
|----------|---------|---------|
| `SCANID_LATEST_VERSION` | `1.1.2` | Version string reported to the app |
| `SCANID_DOWNLOAD_URL` | [ScanID-1.1.2.dmg](https://github.com/GINNOV/poligest/releases/download/scanid-v1.1.2/ScanID-1.1.2.dmg) | Direct asset URL (DMG or ZIP) |
