...
Latest release: [ScanID 1.3.0](https://github.com/GINNOV/poligest/releases/tag/scanid-v1.3.0)

Direct DMG: [ScanID-1.3.0.dmg](https://github.com/GINNOV/poligest/releases/download/scanid-v1.3.0/ScanID-1.3.0.dmg)
...
|----------|---------|---------|
| `SCANID_LATEST_VERSION` | `1.3.0` | Version string reported to the app |
| `SCANID_DOWNLOAD_URL` | [ScanID-1.3.0.dmg](https://github.com/GINNOV/poligest/releases/download/scanid-v1.3.0/ScanID-1.3.0.dmg) | Direct asset URL (DMG or ZIP) |
