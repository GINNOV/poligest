/*
  ...
  - A unique constraint covering the columns `[personalPin]` on the table `User` will be added. If there are existing duplicate values, this will fail.
