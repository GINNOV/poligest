...
export default function NotFound() {
  return (
    <div className="min-h-[60vh] rounded-2xl border border-emerald-100 bg-gradient-to-b from-emerald-50 via-white to-emerald-50 px-6 py-10 shadow-sm">
      <div className="mx-auto flex max-w-4xl flex-col items-center">
        ...
        <div className="w-full rounded-3xl border border-emerald-100 bg-white/95 p-8 text-center shadow-lg shadow-emerald-100/60 backdrop-blur">
          ...
          <p className="mt-3 text-sm leading-6 text-zinc-600 sm:text-base">
            Il contenuto potrebbe essere stato spostato o l&apos;indirizzo potrebbe essere errato. Torna al
            cruscotto per proseguire la navigazione.
          </p>
