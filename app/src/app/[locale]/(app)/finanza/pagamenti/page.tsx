  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <h1 className="text-2xl font-semibold text-zinc-900">Pagamenti pazienti</h1>
      </div>
        ...
        <>
          ...
          <div className="grid gap-4 md:grid-cols-3">
            <div className="rounded-2xl border border-zinc-200 bg-white p-4 shadow-sm">
              ...
              <p className="mt-2 text-2xl font-semibold text-zinc-900">{formatCurrency(totals.total)}</p>
            </div>
            <div className="rounded-2xl border border-zinc-200 bg-white p-4 shadow-sm">
          ...
          <div className="grid gap-6 xl:grid-cols-[1.1fr,0.9fr]">
            <section className="space-y-4 rounded-2xl border border-zinc-200 bg-white p-5 shadow-sm">
              <div>
                ...
                <h2 className="mt-1 text-lg font-semibold text-zinc-900">Prestazioni e residui</h2>
              </div>

              {!quoteItemSummaries.length ? (
                <div className="rounded-xl border border-dashed border-zinc-200 px-4 py-5 text-sm text-zinc-600">
                    ...
                    >
                      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                        <div>
                          ...
                          <p className="text-xs text-zinc-600">Quantità: {item.quantity}</p>
                        </div>
                        <span
            ...
            <section className="space-y-4 rounded-2xl border border-zinc-200 bg-white p-5 shadow-sm">
              <div>
                ...
                <h2 className="mt-1 text-lg font-semibold text-zinc-900">Nuovo incasso</h2>
              </div>
          ...
          <section className="space-y-4 rounded-2xl border border-zinc-200 bg-white p-5 shadow-sm">
            <div>
              ...
              <h2 className="mt-1 text-lg font-semibold text-zinc-900">Pagamenti registrati</h2>
            </div>
                ...
                {payments.map((payment) => (
                  ...
                  >
                    <div className="space-y-1">
                      ...
                      {payment.note ? <p className="text-sm text-zinc-700">{payment.note}</p> : null}
                    </div>
