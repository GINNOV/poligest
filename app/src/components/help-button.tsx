        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/40 p-4 backdrop-blur-[2px]">
          <div className="w-full max-w-[90vw] md:max-w-lg rounded-2xl bg-white shadow-2xl dark:bg-zinc-950 border dark:border-zinc-800 flex flex-col max-h-[90vh] overflow-hidden">
            <div className="p-6 border-b dark:border-zinc-800 flex items-center justify-between shrink-0">
              <div>
                ...
                {activeInstruction.description && (
                  <p className="text-sm text-zinc-500 mt-1">{activeInstruction.description}</p>
                )}
              </div>
              <button 
                onClick={() => setIsOpen(false)}
                className="p-2 text-zinc-400 hover:text-zinc-600 transition"
              >
            ...
            <div className="p-6 border-t dark:border-zinc-800 flex justify-end">
              <button
                onClick={() => setIsOpen(false)}
                className="h-10 rounded-full border border-zinc-200 px-6 text-sm font-semibold text-zinc-700 hover:bg-zinc-50 dark:border-zinc-800 dark:text-zinc-300 dark:hover:bg-zinc-900"
              >
                Chiudi
              </button>
            </div>
